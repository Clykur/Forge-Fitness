...
export function Urgency() {
  ...
  useEffect(() => {
    // Just a fun subtle effect to randomly change the number, though usually it would be fixed or strictly decreasing
    // We'll keep it static here or pulse it, per requirement
  }, []);
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-red-500 font-bold text-lg md:text-xl">Only {spots} spots remaining this week</span>
          </motion.div>
